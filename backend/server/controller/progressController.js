...
exports.updateProgress = async (req, res) => {
  try {
    ...
    console.log("new difficulty is ", newDifficulty);
    ...
    // This should be done after all questions in a topic are completed
    // For now, we'll add the topic to completedTopics when the first question is answered
    // You might want to implement a more sophisticated completion logic
